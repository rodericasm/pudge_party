...
--This is a fatory system that makes behaviour systems.
ai_core = {}

function ai_core:create_behaviour_system(behaviour_list, think_duration)
	local behaviour_system = {}
	behaviour_system.behaviour_list = behaviour_list
	behaviour_system.default_think_duration = think_duration
	...
	function behaviour_system:think()
		...
		if self.current_behaviour.think then
			self.current_behaviour:think(self.default_think_duration)
		end
